...
\newcommand{\coeff}{w}
\newcommand{\optCoeff}{w^*}
\newcommand{\instanceAvg}{\frac{1}{n} \sum_n}
...
\newcommand{\shareRR}[1]{{\langle {#1} \rangle}_{R}} % a generic ring
\newcommand{\shareB}[1]{{\langle {#1} \rangle}_2} % a binary field
\newcommand{\shareF}[1]{{\langle {#1} \rangle}_{k, f}} % fixedpoint sharing
\newcommand{\shareFixed}[3]{{\langle {#1} \rangle}_{#2, #3}} % fixedpoint sharing
\newcommand{\secret}{m}
