...
\commentM{revisit this section to make sure it makes sense for external use}
\commentD{Cut down a major chunk of it so that we only motivate why we chose Araki}
